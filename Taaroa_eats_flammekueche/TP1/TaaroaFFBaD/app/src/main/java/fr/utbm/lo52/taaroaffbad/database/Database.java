...
public class Database extends SQLiteOpenHelper {
    ...
    public static final String VEN_VOL_MARQUE = "marque_volant";//primary key + foreign key
    ...
    private static final String CREATE_VENTE = "create table " + TABLE_VENTE
            ...
            + "primary key(" + VEN_VOL_MARQUE + "," + VEN_VOL_REF + "," + VEN_FAB_ID+ "," + VEN_ACH_ID + "), "
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        //TODO: [ICI] db.execSQL("DROP TABLE IF EXISTS " + TABLE_COMMENTS);
        onCreate(db);
    }
}