...
Java_fr_utbm_lo52_projectndk_LO52MainActivity_read(
        JNIEnv *env,
        jobject obj,
        jstring str) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_fr_utbm_lo52_projectndk_LO52MainActivity_write(
        JNIEnv *env,
        jobject obj,
        jstring str) {
    const char *nativeString = (env)->GetStringUTFChars(str, JNI_FALSE);
...
Java_fr_utbm_lo52_projectndk_LO52MainActivity_stop(
        JNIEnv *env,
        jobject obj,
        jint nb) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_fr_utbm_lo52_projectndk_LO52MainActivity_start(
        JNIEnv *env,
        jobject obj,
        jint nb) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_fr_utbm_lo52_projectndk_LO52MainActivity_reset(
        JNIEnv *env,
        jobject obj) {
