DROP INDEX I_PK_FABRICANT
     ON FABRICANT;

DROP INDEX I_PK_COMMANDE
     ON COMMANDE;

DROP INDEX I_FK_COMMANDE_CLIENT
     ON COMMANDE;

DROP INDEX I_PK_VOLANT
     ON VOLANT;

DROP INDEX I_FK_VOLANT_FABRICANT
     ON VOLANT;

DROP INDEX I_PK_CLIENT
     ON CLIENT;

DROP INDEX I_PK_LIGNE_COMMANDE
     ON LIGNE_COMMANDE;

DROP INDEX I_FK_LIGNE_COMMANDE_COMMANDE
     ON LIGNE_COMMANDE;

DROP INDEX I_FK_LIGNE_COMMANDE_TUBE
     ON LIGNE_COMMANDE;

DROP INDEX I_PK_TUBE
     ON TUBE;

DROP INDEX I_FK_TUBE_VOLANT
     ON TUBE;

DROP INDEX I_PK_VALIDITE
     ON VALIDITE;
...
CREATE  INDEX I_FK_VOLANT_FABRICANT
     ON VOLANT (NOM ASC);
...
CREATE  INDEX I_FK_LIGNE_COMMANDE_COMMANDE
     ON LIGNE_COMMANDE (REF_DE_COMMANDE ASC);

CREATE  INDEX I_FK_LIGNE_COMMANDE_TUBE
     ON LIGNE_COMMANDE (REF ASC,NOMBRE_DE_VOLANTS ASC);
...
INSERT INTO VOLANT (MARQUE, REF)
VALUES ("Yorex","A530");

INSERT INTO TUBE (REF,NOMBRE_EN_STOCK,NOMBRE_DE_VOLANTS,PRIX,IMAGE)
VALUES ("A530",500,12,27,"./src/main/res/raw/images/AS30_1_1.jpg");

INSERT INTO VOLANT (MARQUE, REF)
VALUES ("RSL","Grade 3");

INSERT INTO TUBE (REF,NOMBRE_EN_STOCK,NOMBRE_DE_VOLANTS,PRIX,IMAGE)
VALUES ("Grade 3",5000,12,17,"./src/main/res/raw/images/1015_BLANC_1_2.jpg");

INSERT INTO VOLANT (MARQUE, REF)
VALUES ("RSL","Grade A9");

INSERT INTO TUBE (REF,NOMBRE_EN_STOCK,NOMBRE_DE_VOLANTS,PRIX,IMAGE)
VALUES ("GRADE A9",10000,12,14,"./src/main/res/raw/images/RSLA9_1_1.jpg");

INSERT INTO VOLANT (MARQUE, REF)
VALUES ("RSL","Grade A1");

INSERT INTO TUBE (REF,NOMBRE_EN_STOCK,NOMBRE_DE_VOLANTS,PRIX,IMAGE)
VALUES ("Grade A1",6000,12,21,"./src/main/res/raw/images/1013_1_1.jpg");
