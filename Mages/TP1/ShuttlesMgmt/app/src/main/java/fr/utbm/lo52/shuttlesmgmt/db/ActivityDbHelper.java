...
public class ActivityDbHelper extends SQLiteOpenHelper {
    ...
    public static final String STOCK_REFERENCE = "REFERENCE";
    public static final String STOCK_MARQUE = "MARQUE";
    ...
    private static final String SQL_DELETE_STOCK = "DROP TABLE IF EXISTS " + STOCK_TABLE;
    ...
    private void addinStock(SQLiteDatabase db) {
        ContentValues v1 = new ContentValues();
        v1.put(STOCK_REFERENCE, "AS30");
        v1.put(IMAGE, R.drawable.t1);
        ...
        v2.put(STOCK_REFERENCE, "Grade 3");
        v2.put(IMAGE, R.drawable.t2);
        v2.put(STOCK_MARQUE, "RSL");
        v2.put(PRIX, 16.7);
        v2.put(QUANTITE, 5000);
        db.insert(STOCK_TABLE, null, v2);

        ContentValues v3 = new ContentValues();
        v3.put(STOCK_REFERENCE, "Grade A9");
        v3.put(IMAGE, R.drawable.t3);
        v3.put(STOCK_MARQUE, "RSL");
        v3.put(PRIX, 13.7);
        v3.put(QUANTITE, 10000);
        db.insert(STOCK_TABLE, null, v3);

        ContentValues v4 = new ContentValues();
        v4.put(STOCK_REFERENCE, "Grade A1");
        v4.put(IMAGE, R.drawable.t4);
        v4.put(STOCK_MARQUE, "RSL");
        v4.put(PRIX, 21.0);
        v4.put(QUANTITE, 6000);
