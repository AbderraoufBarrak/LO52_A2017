...
public class SampleContentProviderTest {
    ...
    public void cheese_initiallyEmpty() {
        final Cursor cursor = mContentResolver.query(SampleContentProvider.URI_VOLANT,
    ...
    public void cheese_insert() {
        final Uri itemUri = mContentResolver.insert(SampleContentProvider.URI_VOLANT,
    ...
    public void cheese_delete() {
        final Uri itemUri = mContentResolver.insert(SampleContentProvider.URI_VOLANT,
                cheeseWithName("Daigo"));
        assertThat(itemUri, notNullValue());
        final Cursor cursor1 = mContentResolver.query(SampleContentProvider.URI_VOLANT,
                new String[]{Volant.COLUMN_NAME}, null, null, null);
        ...
        assertThat(count, is(1));
        final Cursor cursor2 = mContentResolver.query(SampleContentProvider.URI_VOLANT,
                new String[]{Volant.COLUMN_NAME}, null, null, null);
    ...
    public void cheese_bulkInsert() {
        final int count = mContentResolver.bulkInsert(SampleContentProvider.URI_VOLANT,
                new ContentValues[]{
    ...
    public void cheese_applyBatch() throws RemoteException, OperationApplicationException {
        ...
        operations.add(ContentProviderOperation
                .newInsert(SampleContentProvider.URI_VOLANT)
